...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x9CE9b3056CD31EdDAd38fD321E6524703717A9d7;
...
contract SafeSpaceFinance is Context, IERC20, Ownable {
   ...
   function findPercentMarketing(uint256 value) public view returns (uint256)  {
    ...
    function _transfer(
        ...
        if (_isExcluded[recipient]) {
            _tokenBalance[recipient] = _tokenBalance[recipient].add(transferAmountTotal);
        }

        emit Transfer(sender, recipient, transferAmountTotal);
    }
